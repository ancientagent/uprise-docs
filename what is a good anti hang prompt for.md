what is a good anti hang prompt for agents using cursor

A good anti-hang prompt for agents using Cursor should help prevent the AI from getting stuck in loops, incomplete responses, or overly verbose explanations. Here are some effective strategies:
